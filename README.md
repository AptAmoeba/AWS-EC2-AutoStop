...
### Installation:
Obtain the EC2-AutoStop XML file (file available above, or [build it yourself](https://github.com/AptAmoeba/AWS-EC2-AutoStop/main/README.md#task-xml) below), then do the following:
